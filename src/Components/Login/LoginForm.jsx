...
const LoginForm = (props) =>{
    return <>
        <form onSubmit={props.handleSubmit} className={style.wrapperForm}>
            <Field placeholder='Login' name='login' component={Input} validate={[require,maxLength50]} className={style.passInput +' ' + style.items}/>
            <Field placeholder='Password' name='password' component={Input} validate={[require,maxLength32]} className={style.passInput +' '+ style.items}/>
